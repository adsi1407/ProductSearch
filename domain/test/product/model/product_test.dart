...
void main() {
  group('constructor',() {
    ...
    test('create product with valid parameters -> instance of Product', () {
      //Arrange
      const productId = 'MCO880327392';
      const title = 'Sony Playstation 4 Slim 1tb Standard Color  Negro Azabache';
      const thumbnail = 'http://http2.mlstatic.com/D_817486-MLA32731749427_112019-I.jpg';
      const price = 1919783;
